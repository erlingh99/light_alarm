...
pub static WIFI_SSID: &str = "Erlings Galaxy S25";
pub static WIFI_PASSWORD: &str = "erlingbest";
// pub static API_HOST: &str = "http://alarm.lan/api/alarms";
pub static TIME_SERVER: &str = "http://192.168.150.22:8000/";
